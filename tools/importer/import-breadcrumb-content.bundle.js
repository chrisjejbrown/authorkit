...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-breadcrumb-content.js
  var import_breadcrumb_content_exports = {};
  __export(import_breadcrumb_content_exports, {
    default: () => import_breadcrumb_content_default
  });
  ...
  var PAGE_TEMPLATE = {
    ...
    "description": "Simple content page with breadcrumbs and default text content",
    "urls": [
      "https://www.bannerhealth.com/es/getcarenow"
    ],
    "blocks": [
      {
        "name": "cards-feature",
  ...
  var import_breadcrumb_content_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_breadcrumb_content_exports);
})();
