...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-physician-directory.js
  var import_physician_directory_exports = {};
  __export(import_physician_directory_exports, {
    default: () => import_physician_directory_default
  });
  ...
  var PAGE_TEMPLATE = {
    ...
    "description": "Physician directory entry page with breadcrumbs and a provider-search widget",
    "urls": [
  ...
  var import_physician_directory_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_physician_directory_exports);
})();
