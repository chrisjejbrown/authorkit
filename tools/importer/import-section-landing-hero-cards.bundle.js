...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-section-landing-hero-cards.js
  var import_section_landing_hero_cards_exports = {};
  __export(import_section_landing_hero_cards_exports, {
    default: () => import_section_landing_hero_cards_default
  });
  ...
  function parse2(element, { document }) {
    ...
    items.forEach((card) => {
      ...
      const titleText = card.querySelector(".accordion-text") || (trigger ? trigger : null);
  ...
  // tools/importer/parsers/personas.js
  ...
  function locate(root, re) {
    const matches = [...root.querySelectorAll("h1,h2,h3,h4,h5,p,div,span,td,a,li")].filter((el) => re.test(el.textContent));
  ...
  var import_section_landing_hero_cards_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_section_landing_hero_cards_exports);
})();
