...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-cards-landing.js
  var import_cards_landing_exports = {};
  __export(import_cards_landing_exports, {
    default: () => import_cards_landing_default
  });
  ...
  var PAGE_TEMPLATE = {
    "name": "cards-landing",
    "description": "Landing page composed of card grids without a dedicated hero",
    "urls": [
      "https://www.bannerhealth.com/networkcolorado"
    ],
    "blocks": [
      {
        "name": "cards-feature",
  ...
  var import_cards_landing_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_cards_landing_exports);
})();
