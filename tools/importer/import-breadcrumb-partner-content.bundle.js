...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-breadcrumb-partner-content.js
  var import_breadcrumb_partner_content_exports = {};
  __export(import_breadcrumb_partner_content_exports, {
    default: () => import_breadcrumb_partner_content_default
  });
  ...
  var PAGE_TEMPLATE = {
    "name": "breadcrumb-partner-content",
    "description": "Partner/info content page with breadcrumbs, hero, default rich text, and a newsletter signup",
    "urls": [
      "https://www.bannerhealth.com/kaiser-permanente",
      "https://www.bannerhealth.com/es/kaiser-permanente"
    ],
    "blocks": [
      {
        "name": "hero",
  ...
  var import_breadcrumb_partner_content_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_breadcrumb_partner_content_exports);
})();
