...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-service-detail-cards-carousel.js
  var import_service_detail_cards_carousel_exports = {};
  __export(import_service_detail_cards_carousel_exports, {
    default: () => import_service_detail_cards_carousel_default
  });

  // tools/importer/parsers/feature-articles.js
  ...
  function parse2(element, { document }) {
    ...
    slides.forEach((slide) => {
      ...
      const primaryHref = titleLink && titleLink.getAttribute("href") || imageLink && imageLink.getAttribute("href") || "";
      let imageCell = "";
      const imageUrl = resolveSlideImageUrl(imageContainer, srcImg);
      if (imageUrl) {
        const newImg = document.createElement("img");
        newImg.setAttribute("src", imageUrl);
        const alt = srcImg && srcImg.getAttribute("alt") || titleLink && titleLink.textContent.trim() || "";
  ...
  // tools/importer/import-service-detail-cards-carousel.js
  var parsers = {
    "feature-articles": parse,
    "carousel": parse2,
    "cards-feature": parse3
  };
  var transformers = [transform];
  var PAGE_TEMPLATE = {
    "name": "service-detail-cards-carousel",
  ...
  var import_service_detail_cards_carousel_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_service_detail_cards_carousel_exports);
})();
